...
namespace Reading_Corner.Controllers
{
    public class StudentsController : Controller
    {
        ...
        // private readonly Reading_CornerContext _context;

        //public StudentsController(Reading_CornerContext context)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Teacher,CurrentBook")] Student student)
        {
            if (id != student.ID)
            {
                return NotFound();
